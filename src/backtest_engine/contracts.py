"""Consumer validation for the D-owned COM06 compatibility fixture proposal."""
...
def _canonical_dataset_hash(objects: Sequence[Mapping[str, Any]]) -> str:
    keys = (
        "content_hash",
        "object_kind",
...
def validate_dataset_manifest(document: Mapping[str, Any]) -> None:
    ...
    actual_hash = _canonical_dataset_hash(objects)
